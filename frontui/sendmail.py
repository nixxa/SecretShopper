...
class MailProvider:
    ...
    def send_checklist_notice(self, author_mail, checklist):
        ...
        body = "<h2>Контрольный лист посещения сохранен</h2>\
            ...
            <a href='http://secret-shopper.net/checklist/edit/{0}'>http://secret-shopper.net/checklist/edit/{0}</a></p>\
            <p>Для добавления файлов воспользуйтесь ссылкой \
            <a href='http://secret-shopper.net/checklist/addfiles/{0}'>http://secret-shopper.net/checklist/addfiles/{0}</a></p>\
